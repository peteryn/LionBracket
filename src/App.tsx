		...
		<div className="home-area">
			...
			<div className="home-grid">
				...
				<RegionCard regionName="South America" color="round-middle-text"
							data={["/south_america_open_4", "/south_america_open_5", "/south_america_open_6"]}/>
				...
				<RegionCard regionName="Asia-Pacific" color="pink-text"
							data={["/asia_pacific_open_4", "/asia_pacific_open_5", "/asia_pacific_open_6"]}/>
				<RegionCard regionName="Sub-Saharan Africa" color="orange-text"
							data={["/sub_saharan_africa_open_4", "/sub_saharan_africa_open_5", "/sub_saharan_africa_open_6"]}/>
			</div>
		</div>
	);
}